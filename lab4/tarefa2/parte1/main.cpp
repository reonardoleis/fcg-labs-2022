...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 600, "INF01047 - 316357 - Leonardo Reis da Silva", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
...
void ComputeNormals(ObjModel* model)
{
    ...
    for (size_t shape = 0; shape < model->shapes.size(); ++shape)
    {
        ...
        for (size_t triangle = 0; triangle < num_triangles; ++triangle)
        {
            ...
            // [TALVEZ] PREENCHA AQUI o cálculo da normal de um triângulo cujos vértices
